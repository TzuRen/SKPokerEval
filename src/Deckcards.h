...
uint_fast16_t const suit_kronecker[NUMBER_OF_SUITS][DECK_SIZE] = {
    {ACE_FLUSH,   0, 0, 0, KING_FLUSH,  0, 0, 0, QUEEN_FLUSH, 0, 0, 0,
     ...
     FIVE_FLUSH,  0, 0, 0, FOUR_FLUSH,  0, 0, 0, THREE_FLUSH, 0, 0, 0,
     TWO_FLUSH,   0, 0, 0},
    {0, ACE_FLUSH,   0, 0, 0, KING_FLUSH,  0, 0, 0, QUEEN_FLUSH, 0, 0,
     ...
     0, FIVE_FLUSH,  0, 0, 0, FOUR_FLUSH,  0, 0, 0, THREE_FLUSH, 0, 0,
     0, TWO_FLUSH,   0, 0},
    {0, 0, ACE_FLUSH,   0, 0, 0, KING_FLUSH,  0, 0, 0, QUEEN_FLUSH, 0,
     ...
     0, 0, FIVE_FLUSH,  0, 0, 0, FOUR_FLUSH,  0, 0, 0, THREE_FLUSH, 0,
     0, 0, TWO_FLUSH,   0},
    {0, 0, 0, ACE_FLUSH,   0, 0, 0, KING_FLUSH,  0, 0, 0, QUEEN_FLUSH,
     ...
     0, 0, 0, FIVE_FLUSH,  0, 0, 0, FOUR_FLUSH,  0, 0, 0, THREE_FLUSH,
     0, 0, 0, TWO_FLUSH}};
